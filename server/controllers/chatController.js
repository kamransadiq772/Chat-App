...
const renameGroupChat = asyncHandler(async (req, res) => {
    ...
    const updatedChat = await Chat.findByIdAndUpdate(
        ...
        {
            chatName  //data to updata field name is chatName so id would be like chatName : chatName as both are same so we can write once
        }, {
        new: true  //If false return the value before update, no it will return the new updated value
    }
    )
        .populate("users", "-password")
        .populate("groupAdmin", "-password")
